...
setLoading(false);
  ...
  <div className="relative min-h-screen overflow-hidden bg-secondary pt-20 text-dark">
    ...
    <div className="relative mx-auto flex max-w-6xl items-center justify-center px-6 py-8 md:py-10">
      <motion.div
      ...
      >
        ...
        <div className="hidden flex-col justify-center bg-dark2 px-10 py-12 text-white lg:flex">
          <div className="inline-flex w-fit items-center rounded-full border border-white/10 bg-white/10 px-4 py-2">
          ...
          <div className="mx-auto max-w-md">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              <div>
                ...
                <div className="flex items-center gap-3 rounded-2xl border border-dark/10 bg-white/60 px-4 py-3 backdrop-blur-sm transition focus-within:border-primary/20 focus-within:ring-2 focus-within:ring-primary/20">
              ...
              <button
                type="submit"
                disabled={loading}
                className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-dark2 px-6 py-3.5 font-semibold text-white shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.01] hover:opacity-95 disabled:cursor-not-allowed disabled:opacity-70"
              >
                <LogIn size={18} />
                Se connecter
              </button>
    ...
    {loading && (
      <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/40 backdrop-blur-sm">
        <div className="flex flex-col items-center gap-4 rounded-[28px] bg-white px-6 py-5 shadow-xl">
