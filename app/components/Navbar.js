...
import { Gift, User, MapPin, ShoppingCart } from "lucide-react";
...
export default function Navbar() {
  ...
  <div className="hidden lg:flex items-center gap-3">
    ...
    <Link href="/panier" className="relative p-2 rounded-lg hover:bg-white/10 transition">
      <ShoppingCart size={20} className="text-white/80 hover:text-accent transition-colors" />
...
{open && (
  <div
    className="absolute right-4 top-20 lg:hidden w-64 rounded-xl bg-accent/95 backdrop-blur shadow-lg ring-1 ring-dark/10 p-6"
  >
